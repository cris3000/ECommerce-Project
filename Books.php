...
$result = $mysqli->query("SELECT * FROM product WHERE category = 'Books' AND visibility='Public'");
...
<?php
  ...
  <div id='rows' class='columns'>
   ...
   <div class='row'>
<p> <a id='categoryimage' class='five columns'><img src=images/$imgpath width='90%'/></a>
	 $details</p>
      <p>DatePosted: $Posted </p>
	  
	 <a class='button' href='Books1.php?row=$id'>Buy </a>
